...
public class AdminController {
	...
	public void updateStatus(@PathVariable(value = "id") long id,@PathVariable(value = "isAdmin") String isAdmin,
			@PathVariable(value = "isBanned") String isBanned) {
		User user = userService.getUser(id);
		user.setAdmin(Boolean.valueOf(isAdmin));
		user.setBanned(Boolean.valueOf(isBanned));
